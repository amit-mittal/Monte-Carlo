...
main <- function(){
	a<-c(100, 1000, 2000, 4000, 5000);
	init_values<-c(5, 73, 128, 23451, 2341);
	bound<-1000;
	
	for(index in 1:5){
		func(init_values[index], 1597, 0, 244944, bound);
	}


	for(index in 1:5){
		func(init_values[4], 1597, 0, 244944, a[index]);
	}
	
	cat("\n\n\n");
	
	for(index in 1:5){
		func(init_values[index], 51749, 0, 244944, bound);
	}
	
	for(index in 1:5){
		func(init_values[4], 51749, 0, 244944, a[index]);
	}
}
